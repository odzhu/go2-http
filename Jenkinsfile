    ...
    stages {
      stage('CI Build and push snapshpt') {
        ...
        steps {
          ...
          dir ('/home/jenkins/go/src/github.com/odzhu/go2-http') {
            checkout scm
            container('go') {
              sh "make preview"
          ...
          dir ('/home/jenkins/go/src/github.com/odzhu/go2-http/charts/preview') {
           container('go') {
             sh "make linux"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/odzhu/go2-http/charts/go2-http') {
